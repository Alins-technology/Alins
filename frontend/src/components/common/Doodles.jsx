...
export function WavyUnderline({ className = '' }) {
  return (
    <svg viewBox="0 0 200 16" fill="none" aria-hidden className={className} preserveAspectRatio="none">
      <path
...
export function PlusCluster({ className = '' }) {
  return (
...
export function Zigzag({ className = '' }) {
  return (
    <svg viewBox="0 0 100 30" fill="none" aria-hidden className={className} preserveAspectRatio="none">
      <path
...
export function DashArrow({ className = '' }) {
  return (
    <svg viewBox="0 0 90 60" fill="none" aria-hidden className={className}>
      <path
